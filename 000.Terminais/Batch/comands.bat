...
BCDEDIT
:: Define propriedades no banco de dados de inicialização para
...
COLOR
:: Define as cores padrão do primeiro plano e da tela de fundo
:: do console.
COMP
...
CONVERT
:: Converte volumes FAT em NTFS. Não é possível converter a unidade atual.
COPY
...
DRIVERQUERY
:: Exibe status e propriedades do driver de dispositivo atual.
ECHO
:: Exibe mensagens ou ativa/desativa o eco de comandos.
ENDLOCAL
...
FC
:: Compara dois arquivos ou grupos de arquivos e exibe as
:: diferenças entre eles.
FIND
:: Procura uma cadeia de caracteres de texto em um ou mais arquivos.
FINDSTR
:: Procura cadeias de caracteres em arquivos.
FOR
:: Executa um determinado comando para cada arquivo em um grupo de arquivos.
FORMAT
:: Formata um disco para ser usado com o Windows.
FSUTIL
:: Exibe ou configura as propriedades do sistema de arquivos.
FTYPE
:: Exibe ou modifica os tipos de arquivo utilizados em
:: associações de extensões de arquivo.
GOTO
:: Direciona o interpretador de comandos do Windows para uma
:: linha identificada em um programa em lotes.
GPRESULT
:: Exibe informações de política de grupo para o computador ou usuário.
GRAFTABL
:: Permite que o Windows exiba um conjunto de caracteres
:: estendidos em modo gráfico.
HELP
:: Fornece informações de ajuda sobre comandos do Windows.
ICACLS
:: Exibir, modificar, fazer backup ou restaurar ACLs de
...
:: Cria um diretório.
MKLINK
:: Cria Links Simbólicos e Links Físicos
MODE
...
OPENFILES
:: Exibe arquivos abertos por usuários remotos para um compartilhamento de arquivo.
PATH
...
POPD
:: Restaura o valor anterior do diretório atual salvo porPUSHD.
PRINT
:: Imprime um arquivo de texto.
PROMPT
:: Altera o prompt de comando do Windows.
PUSHD
:: Salva o diretório atual e o altera em seguida.
RD
:: Remove um diretório.
RECOVER
:: Recupera informações legíveis de um disco com defeito ou danificado.
REM
:: Grava comentários (observações) em arquivos em lotes ou no CONFIG.SYS.
REN
...
:: Remove um diretório.
ROBOCOPY
:: Utilitário avançado para copiar arquivos e árvores de diretório
SET
...
SC
:: Exibe ou configura serviços (processos em segundo plano).
SCHTASKS       
:: Agenda a execução de comandos e programas em um computador.
SHIFT          
...
TASKLIST       
:: Exibe todas as tarefas em execução no momento, inclusive serviços.
TASKKILL       
:: Termina ou interrompe um processo ou aplicativo em execução.
TIME           
...
VOL            
:: Exibe o rótulo de volume e o número de série de um disco.
XCOPY          
:: Copia arquivos e árvores de diretórios.
WMIC           
:: Exibe informações WMI em um comando interativo do shell.