...
class Application:
    def __init__(self, master=None):
        ...
        self.lblidusuario = Label(
            self.container2, text="idUsuario:", font=self.fonte, width=10)
        ...
        self.lbltelefone = Label(
            self.container4, text="Telefone:", font=self.fonte, width=10)
        ...
        self.lblemail = Label(
            self.container5, text="E-mail:", font=self.fonte, width=10)
        ...
        self.lblusuario = Label(
            self.container6, text="Usuário:", font=self.fonte, width=10)
